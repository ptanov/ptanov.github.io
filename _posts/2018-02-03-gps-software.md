...
Текущите, които ползвам:
 - <https://garmin.opentopomap.org/#bulgaria>
 - <https://www.openfietsmap.nl/downloads/europe>
 - <https://garmin3.bbbike.org/>
 - <http://www.gmaptool.eu/en/content/south-east-europe>
 - <https://www.wanderreitkarte.de/garmin_de.php>
 - <https://www.freizeitkarte-osm.de/garmin/en/more-countries.html>
 - <https://bgmountains.org/en/maps/garmin-maps/category/9-bgmountains>
...
GPS MAP 66 би бил по-добрият вариант ако ходиш и добавяш/откриваш нови маршрути, в по-сурово време и като цяло по-професионално ако се занимаваш и на лимита на оцеляването ако си, неща които са далеч от начина на ползване на обикновения човек (като мен).
